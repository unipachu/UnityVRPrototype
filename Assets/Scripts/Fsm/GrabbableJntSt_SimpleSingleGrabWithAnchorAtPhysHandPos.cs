...
public class GrabbableJntSt_SimpleSingleGrabWithAnchorAtPhysHandPos : IFsmSt {
    IGrabbable grabbable;

    public GrabbableJntSt_SimpleSingleGrabWithAnchorAtPhysHandPos(IGrabbable grabbable) {
